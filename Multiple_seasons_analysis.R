...
res_list <- readRDS("results/augmented_multiple_seasonsGN1.rds")
first_year <- 1999
...
# Render table
kable(post_numb_block_across_years_wide, format = 'latex', digits = 3)
...
# Generate LaTeX code as a string
latex_table <- kable(post_numb_block_across_years_wide,
                     format = "latex",
                     digits = 3)
